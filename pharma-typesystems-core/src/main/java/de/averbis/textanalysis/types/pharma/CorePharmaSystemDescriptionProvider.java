...
public class CorePharmaSystemDescriptionProvider extends TypeSystemProvider_ImplBase {

	public CorePharmaSystemDescriptionProvider() {

		setTypeSystemLocations( //
				"AdverseEventTypeSystem.xml", //
				"IdmpTypeSystem.xml", //
				"Module3TypeSystem.xml", //
				"PharmaConceptTypeSystem.xml", //
				"SmpcSectionTypeSystem.xml", //
				"SmpcTypeSystem.xml");
	}
}
